    ...
    <div className="min-h-screen bg-surface-dark flex flex-col">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-surface-border/50">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold text-white gradient-brand rounded-xl hover:opacity-90 transition-opacity cursor-pointer"
          >
            Get Started
          </button>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className="animate-fade-in max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass mb-8 text-sm text-brand-300 font-medium">
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              onClick={() => router.push('/register')}
              className="flex items-center gap-2 px-8 py-3.5 text-base font-semibold text-white gradient-brand rounded-2xl hover:opacity-90 transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
            >
              Start for Free
