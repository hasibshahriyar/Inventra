...
export default function InventoryPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Realtime Banner */}
      {realtimeEvent && (
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl px-4 py-2.5 text-sm text-blue-300 flex items-center gap-2 animate-slide-up">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white gradient-blue rounded-xl hover:opacity-90 transition-all cursor-pointer"
        >
