      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass rounded-2xl p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground placeholder:text-placeholder focus:border-blue-500 transition-all"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground placeholder:text-placeholder focus:border-blue-500 font-mono transition-all"
                    placeholder="PRD-001"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground placeholder:text-placeholder focus:border-blue-500 transition-all resize-none"
          ...
          <div className="space-y-6">
            <div className="glass rounded-2xl p-6">
              ...
              <div className="relative group rounded-xl border-2 border-dashed border-border overflow-hidden bg-background transition-all hover:border-blue-500/50 aspect-square flex flex-col items-center justify-center text-center cursor-pointer">
                <input
                  type="file"
                  accept="image/*"
                ...
                {previewUrl ? (
                  ...
                  <div className="p-4">
                    <UploadCloud className="w-8 h-8 text-muted mx-auto mb-2 group-hover:text-blue-400 transition-colors" />
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <select
                ...
                className="w-full px-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground focus:border-blue-500 transition-all appearance-none"
              >
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-border/50">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex items-center gap-2 px-8 py-2.5 text-sm font-semibold text-white gradient-blue rounded-xl hover:opacity-90 transition-all disabled:opacity-50 cursor-pointer"
          >
